...
function __echo_cd_help {
    ...
    echo -e "	-h, --help 	display command description"
...
function __echo_create_cd_alias {
	echo -e "Usage: create_custom_cd_aliases."
	echo -e "Create custom cd aliases interactively."
    echo -e "	-h, --help 	display command description"
	__echo_check_our_repo
}
